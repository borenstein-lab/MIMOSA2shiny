...
#ten_spec_dat = process_abundances("data/testData/sim_data/allSpeciesEnv5.txt", "data/testData/sim_data/allMetabolitesEnv5.txt", fluxes_file = "data/testData/sim_data/allMetFluxesEnv5.txt", simulated = T)
  ...
  config_table = data.table(V1 = c("database", "genomeChoices","metType", "kegg_prefix", "data_prefix", "vsearch_path", "revRxns"), 
                          V2 = c(get_text("database_choices")[2], get_text("source_choices")[2], get_text("met_type_choices")[1], "data/KEGGfiles/", "/net/borenstein/vol1/DATA_REFERENCE/MIMOSA2_REFDATA/", "bin/vsearch", T))
